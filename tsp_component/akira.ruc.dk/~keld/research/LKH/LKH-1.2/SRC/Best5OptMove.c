...
Node *
 Best5OptMove(Node * t1, Node * t2, long *G0, long *Gain)
{
    ...
    /* Choose t3 as a candidate edge emanating from t2 */
    for (Nt2 = t2->CandidateSet; t3 = Nt2->To; Nt2++) {
        ...
        for (X4 = 1; X4 <= 2; X4++) {
            ...
            /* Choose t5 as a candidate edge emanating from t4 */
            for (Nt4 = t4->CandidateSet; t5 = Nt4->To; Nt4++) {
                if (t5 == t4->Pred || t5 == t4->Suc ||
                    (G3 = G2 - Nt4->Cost) <= 0)
                    continue;
                /* Choose t6 as one of t5's two neibors on the tour */
                for (X6 = 1; X6 <= 2; X6++) {
                    if (X4 == 1) {
                        if (X6 == 1) {
                    ...
                    /* Choose t7 as a candidate edge emanating from t6 */
                    for (Nt6 = t6->CandidateSet; t7 = Nt6->To; Nt6++) {
                        if (t7 == t6->Pred || t7 == t6->Suc ||
                            ...
                            (G5 = G4 - Nt6->Cost) <= 0)
                            continue;
                        /* Choose t8 as one of t7's two neibors on the tour */
                        for (X8 = 1; X8 <= 2; X8++) {
                            if (X8 == 1) {
                                Case8 = Case6;
                                switch (Case6) {
                            ...
                            if (Case6 == 7 && !BTW273 &&
                                ...
                                continue;
                            if (Case6 == 8 && !BTW273 && !BETWEEN(t4, t7, t5))
                                break;
                            G6 = G5 + C(t7, t8);
                            if (t8 != t1 &&
                                (Case6 == 3 ? BTW574 :
                            ...
                            /* Choose t9 as a candidate edge emanating from t8 */
                            for (Nt8 = t8->CandidateSet; t9 = Nt8->To; Nt8++) {
                                if (t9 == t8->Pred || t9 == t8->Suc ||
                                    ...
                                    (G7 = G6 - Nt8->Cost) <= 0)
                                    continue;
                                /* Choose t10 as one of t9's two neibors on the tour */
                                for (X10 = 1; X10 <= 2; X10++) {
                                    if (X10 == 1) {
                                        t10 = 0;
                                        switch (Case8) {
                                        case 1:
                                            t10 = (BTW275 ?
                                                   BETWEEN(t8, t9, t5) || BETWEEN(t3, t9, t1) :
                                                   BTW674 ?
                                                   BETWEEN(t7, t9, t1) :
                                                   BETWEEN(t7, t9, t5)) ?
                                                PRED(t9) : SUC(t9);
                                        ...
                                        case 2:
                                            t10 = (BTW376 ?
                                                   BETWEEN(t8, t9, t4) :
                                                   BTW571 ?
                                                   BETWEEN(t7, t9, t1) || BETWEEN(t3, t9, t6) :
                                                   BETWEEN(t7, t9, t1)) ?
                                                PRED(t9) : SUC(t9);
                                            Case10 = 23;
                                            break;
                                    ...
                                    if ((G8 > BestG8 ||
                                         (G8 == BestG8 && Near(T9, T10) && !Near(t9, t10))) &&
