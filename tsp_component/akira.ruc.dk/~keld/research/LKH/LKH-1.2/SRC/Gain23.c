    ...
    for (X2 = 1; X2 <= 2; X2++) {
        ...
        do {
            ...
            if (Fixed(s1, s2))
                continue;
            G0 = C(s1, s2);
            /* Choose s3 as a candidate edge emanating from s2 */
        ...
        do {
            ...
            for (Ns2 = s2->CandidateSet; s3 = Ns2->To; Ns2++) {
                ...
                for (X4 = 1; X4 <= 2; X4++) {
                    ...
                    /* Choose s5 as a candidate edge emanating from s4 */
                    for (Ns4 = s4->CandidateSet; s5 = Ns4->To; Ns4++) {
                        ...
                        for (X6 = 1; X6 <= 2; X6++) {
                            ...
                            if (!Forbidden(s6, s1) &&
                                ...
                                if ((Gain = BridgeGain(s1, s2, s3, s4, s5, s6,
                                                0, 0, Case6, Gain6)) > 0)
                                    return Gain;
                            }
                            /* Choose s7 as a candidate edge emanating from s6 */
                            for (Ns6 = s6->CandidateSet; s7 = Ns6->To; Ns6++) {
                                ...
                                for (X8 = 1; X8 <= 2; X8++) {
                                    ...
                                    if ((!c || G6 - c(s8, s1) > 0) &&
                                        ...
                                        if (Gain > Gain6 &&
                                            (Gain = BridgeGain(s1, s2, s3, s4, s5, s6, s7, s8,
                                                       Case6, Gain)) > 0)
                                            return Gain;
                                    }
                                }
